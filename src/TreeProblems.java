...
public class TreeProblems {
  ...
  */
  public static int help(Map<String, List<String>> tree, String root) {
    if (!tree.containsKey(root) || tree.get(root).isEmpty()) {
      return 1; 
  }

  int max = 0;
  for (String child : tree.get(root)) {
      int depth = help(tree, child);
